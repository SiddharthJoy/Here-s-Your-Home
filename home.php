   ...
   <body>
                        ...
                        <div class="login-sr">
                           <div class="login-signup">
                              <ul>
                                  ...
                                  <li><a href="explore.php"><b>Explore</a></li>
                                  ...
                                  <?php
                                    ...
                                    if($userprofile){
                                      ?>
                                      <li><a  href="profile.php"><b>Profile</a></li>
     ...
     ? <div class="profile-box banner-p">
      ...
      <div class="product-profile-box">
         <div class="container">
            <div class="row">
               <div class="col-md-1 col-sm-4 pr">
                     ...
                     <div class="panel with-nav-tabs panel-default">
                        <div class="panel-heading clearfix">
                           <ul class="nav nav-tabs pull-left">
                              ...
                              <li><a class="w3-input w3-white w3-xxlarge w3-animate-input">Recent Posts</a></li>
...
?>
 ...
 <?php while($row=mysqli_fetch_array($result44)) { ?>
     ...
     <a href="showlocation.php?pid=<?php echo $row['ID']; ?>" class="w3-button w3-teal"  >Show on Map</a>
