    ...
    directionsService.route(request, function(response, status) {
      if (status == google.maps.DirectionsStatus.OK) {
		...
		directionsDisplay.setDirections(response);
		 ...
		 const output = document.querySelector('#output');
         output.innerHTML = "<p>Driving distance <i class='material-icons'>airport_shuttle</i> : " + response.routes[0].legs[0].distance.text + "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp    Duration <i class='material-icons'>hourglass_top</i> : " + response.routes[0].legs[0].duration.text + "</p>.</div>";
...
<div class = "holiday" id="output"></div>
